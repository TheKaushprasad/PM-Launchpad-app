  ...
  },
  {
    ...
    assignment: (
      <div className="space-y-4">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
             <p className="mb-2">Identify one product you love and one you hate. Write down 3 reasons for each.</p>
             <p className="text-xs text-gray-500">This helps you start analyzing products critically rather than just consuming them.</p>
          </div>
      </div>
    )
  }
