...
export const About: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div className="relative rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 text-white shadow-xl bg-zinc-900 overflow-hidden isolate">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-blue-900 to-zinc-900 -z-10"></div>
        <div className="absolute top-0 right-0 -z-10 w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-indigo-500 opacity-10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-center">
            <div className="space-y-6 text-center lg:text-left">
                ...
                <p className="text-indigo-100 text-base md:text-lg leading-[1.6] max-w-lg mx-auto lg:mx-0 opacity-90">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-2">
                    <button 
                        ...
                        className="w-full sm:w-auto px-6 py-3 bg-white text-zinc-900 rounded-xl font-bold text-sm shadow-lg hover:bg-zinc-50 transition-all flex items-center justify-center gap-2"
                    >
                        Start Learning <ArrowRight className="w-4 h-4" />
                    </button>
                    <button className="w-full sm:w-auto px-6 py-3 bg-white/10 text-white border border-white/20 rounded-xl font-bold text-sm hover:bg-white/20 transition-all">
                        Curriculum
                    </button>
                </div>
            </div>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4 shrink-0">
                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                    <div className="w-12 h-12 rounded-xl bg-indigo-500 flex items-center justify-center text-white font-black text-xl mb-4">45</div>
                    <p className="text-indigo-200 text-[10px] font-black uppercase tracking-wider mb-1">Duration</p>
                ...
                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl mt-8">
                    <div className="w-12 h-12 rounded-xl bg-blue-500 flex items-center justify-center text-white font-black text-xl mb-4">3+</div>
                    <p className="text-indigo-200 text-[10px] font-black uppercase tracking-wider mb-1">Portfolio</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 md:gap-10">
        <div className="xl:col-span-2 space-y-8 md:space-y-10">
            <section>
                ...
                <div className="prose prose-zinc prose-sm md:prose-base max-w-none text-zinc-600 !leading-[1.6]">
                    <p className="mb-4">
        ...
        <div className="space-y-6">
            <div className="bg-zinc-900 text-white rounded-[2rem] p-6 md:p-8 shadow-xl relative overflow-hidden">
                ...
                <button onClick={() => navigate('/dashboard/day/0')} className="w-full mt-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-black text-sm transition-all shadow-lg flex items-center justify-center gap-2">
                    Start Learning <ArrowRight className="w-4 h-4" />
                </button>
            </div>
    ...
    return (
        <div className="p-5 rounded-xl bg-white border border-zinc-100 shadow-sm hover:border-indigo-100 transition-all">
            ...
            <ul className="space-y-1.5">
                {skills.map((skill, i) => (
                    <li key={i} className="text-[11px] md:text-xs text-zinc-500 flex items-center gap-2 font-medium">
