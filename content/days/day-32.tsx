    ...
    <div className="space-y-4 md:space-y-5 text-left">
      ...
      <section className="space-y-3.5 md:space-y-4">
        ...
        <div className="bg-white border border-zinc-100 p-4 sm:p-5 rounded-2xl shadow-sm space-y-6">
           ...
           <div className="bg-orange-50 p-4 rounded-2xl border-l-4 border-orange-500 italic">
      ...
      <section className="space-y-3.5 md:space-y-4">
        ...
        <div className="space-y-2.5">
           ...
           <div className="bg-zinc-900 text-white p-4 sm:p-5 rounded-2xl space-y-8 border-t-8 border-emerald-500">
              ...
              <div className="p-4 bg-white/5 rounded-2xl border border-white/10 italic text-[11px] text-zinc-500">
        ...
        <div className="space-y-2.5">
           ...
           <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-3 md:gap-3.5 p-4 sm:p-5 bg-zinc-50 border border-zinc-200 rounded-2xl items-center">
