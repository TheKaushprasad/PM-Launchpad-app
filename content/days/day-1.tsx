    ...
    <div className="space-y-4 md:space-y-5 text-left">
      ...
      <section className="space-y-3.5 md:space-y-4">
        ...
        <div className="space-y-2.5">
          ...
          <div className="bg-zinc-50 p-4 sm:p-5 rounded-2xl border border-zinc-200 overflow-hidden">
            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-zinc-400 mb-2.5">Why PMs emerge: Company Growth Stages</h3>
        ...
        <div className="space-y-2.5">
          ...
          <blockquote className="p-4 sm:p-5 bg-zinc-900 text-white rounded-2xl border-l-8 border-indigo-600">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-3.5">
            ...
            <div className="p-4 bg-pink-50 border border-pink-100 rounded-3xl">
        ...
        <div className="space-y-2.5">
          ...
          <div className="space-y-2.5">
            {[
              ...
              <div key={type.id} className={`p-4 sm:p-5 rounded-2xl border ${type.color}`}>
                ...
                <p className="text-sm font-bold mb-2.5 flex items-start gap-2">
                ...
                {type.skills && (
                  <div className="mt-3 pt-6 border-t border-white/50">
        ...
        <div className="bg-zinc-50 p-4 sm:p-5 rounded-2xl border border-zinc-200">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex flex-col md:flex-row gap-4 p-4 bg-white rounded-2xl border border-zinc-100">
