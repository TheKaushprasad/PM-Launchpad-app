  ...
  return (
    <div className="space-y-4 md:space-y-5 text-left">
      ...
      <section className="space-y-3.5 md:space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-3.5">
          {[
            ...
            <div key={step.id} className="p-4 sm:p-5 bg-white border border-zinc-100 rounded-2xl shadow-sm space-y-4">
      ...
      <section className="space-y-3.5 md:space-y-4">
        ...
        <div className="p-4 sm:p-5 bg-white border border-zinc-100 rounded-2xl shadow-sm relative overflow-hidden group">
           ...
           <div className="relative z-10 space-y-8">
              <div className="flex flex-col md:flex-row md:items-end gap-3 md:gap-3.5 border-b border-zinc-100 pb-8">
      ...
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-3.5">
           {[
             ...
             <div key={i} className="p-4 bg-white border border-zinc-100 rounded-3xl shadow-sm space-y-3">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-3.5 md:gap-4">
        <div className="bg-zinc-900 text-white p-4 sm:p-5 rounded-2xl border-t-8 border-indigo-500 relative overflow-hidden">
          <Bot className="absolute top-4 right-4 w-12 h-12 text-white/10" />
          <h2 className="text-2xl font-black text-indigo-400 mb-2.5">AI Accelerator</h2>
        ...
        <div className="bg-white border border-zinc-100 p-4 sm:p-5 rounded-2xl shadow-sm space-y-6">
           <h2 className="text-lg md:text-xl font-black text-zinc-900 mb-4">Spotify Case Study</h2>
           <div className="space-y-4">
